...
public class ListarTodasLasCompetencias extends JPanel {
	...
	private void armarPantalla(List<Object> filtrosAnteriores) {
		...
		*/
		...
		Dimension textoDimension = new Dimension(270, 30);
		...
		usuario.setMinimumSize(textoDimension);
		usuario.setMaximumSize(textoDimension);
		usuario.setPreferredSize(textoDimension);
		...
		rellenoPanel2.setMinimumSize(new Dimension(770, 30));
		rellenoPanel2.setMaximumSize(new Dimension(770, 30));
		rellenoPanel2.setPreferredSize(new Dimension(770, 30));
		...
		auxEspacio.setMinimumSize(new Dimension(790, 30));
		auxEspacio.setMaximumSize(new Dimension(790, 30));
		auxEspacio.setPreferredSize(new Dimension(790, 30));
		...
		constraints.gridx = 4;
		auxFiltros.add(usuario, constraints);
		...
		//Dimension Tabla 
		Dimension tamTabla = new Dimension(1125, 330);
		...
		tablaCompetencias.getTableHeader().setMinimumSize(new Dimension(1125, 50));
		tablaCompetencias.getTableHeader().setMaximumSize(new Dimension(1125, 50));
		tablaCompetencias.getTableHeader().setPreferredSize(new Dimension(1125, 50));
		...
		auxEspacio2.setMinimumSize(new Dimension(815, 30));
		auxEspacio2.setMaximumSize(new Dimension(815, 30));
		auxEspacio2.setPreferredSize(new Dimension(815, 30));
		...
		buscar.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				auxEspacio.setMaximumSize(new Dimension(960, 30));
				auxEspacio.setPreferredSize(new Dimension(960, 30));
		...
		agregar.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				JPanel altaCompetencia = new AltaCompetencia(tpPanel, filtros, "ListarTodasLasCompetencias");
		...
		Document documento = nombreCompetencia.getDocument();
		documento.addDocumentListener(new JButtonStateController(buscar));
		...
		Document documentoU = usuario.getDocument();
		documentoU.addDocumentListener(new JButtonStateController(buscar));
			    
		usuario.addKeyListener(new KeyAdapter() {
		    public void keyTyped(KeyEvent e) { 
		        if (usuario.getText().length() >= 150 ) e.consume(); 
		    }  
		});
		...
		if(!filtrosAnteriores.isEmpty()) {
			...
			if(!filtrosAnteriores.get(4).equals(null)) {
				usuario.setText((String) filtrosAnteriores.get(4));
			}
